export default function Home() {
  return (
    ...
    >
      ...
      <main className="relative z-10 min-h-screen px-4 sm:px-6 lg:px-8 pt-24 sm:pt-32 pb-16">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            {/* Email Signup */}
            <div className="w-full max-w-lg mx-auto mb-12 px-4 sm:px-0 relative z-20">
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                <input
                  type="email"
                  placeholder="Enter your email address"
                  aria-label="Email address"
                  className="flex-1 px-4 sm:px-5 py-3 sm:py-4 rounded-xl bg-white/10 border border-gray-700/50 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#09C0F9]/50 focus:border-[#09C0F9]/50 backdrop-blur-sm transition-all duration-300 text-sm sm:text-base min-h-[48px] relative z-20"
                />
                <button className="px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-[#09C0F9] to-[#0EA5E9] hover:from-[#0EA5E9] hover:to-[#0284C7] text-black font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl hover:shadow-[#09C0F9]/25 text-sm sm:text-base whitespace-nowrap relative z-20">
                  Join Us
                </button>
              </div>
            </div>
          ...
          <div className="relative mt-12 sm:mt-16 lg:mt-20">
            <div className="w-72 h-72 sm:w-80 sm:h-80 md:w-96 md:h-96 lg:w-[500px] lg:h-[500px] mx-auto">
              ...
              <div className="absolute inset-12 rounded-full bg-gradient-to-r from-[#09C0F9]/60 via-[#0EA5E9]/80 to-[#0284C7]/60 backdrop-blur-sm border border-[#09C0F9]/30 shadow-2xl shadow-[#09C0F9]/20">
                ...
                <div
                  className="absolute inset-0 rounded-full bg-gradient-to-tr from-transparent via-white/10 to-transparent animate-spin"
                  style={{ animationDuration: "20s" }}
                ></div>
                <div
                  className="absolute inset-2 rounded-full bg-gradient-to-bl from-transparent via-white/5 to-transparent animate-spin"
                  style={{
                ...
                ></div>
                <div
                  className="absolute inset-4 rounded-full bg-gradient-to-r from-transparent via-white/8 to-transparent animate-spin"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl border border-gray-800/50 hover:border-[#09C0F9]/30 p-8 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-[#09C0F9]/10">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                Build autonomous systems, robotic arms, and intelligent machines that solve real-world problems.
              </p>
            ...
            <div className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl border border-gray-800/50 hover:border-[#09C0F9]/30 p-8 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-[#09C0F9]/10">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                Master modern programming languages and frameworks to create innovative software solutions.
              </p>
              <ul className="space-y-2 text-sm text-gray-400">
                <li className="flex items-center">
                  <div className="w-1.5 h-1.5 bg-[#09C0F9] rounded-full mr-3"></div>
            ...
            <div className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl border border-gray-800/50 hover:border-[#09C0F9]/30 p-8 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-[#09C0F9]/10">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                Explore the cosmos through observation, data analysis, and space technology research.
              </p>
              <ul className="space-y-2 text-sm text-gray-400">
                <li className="flex items-center">
                  <div className="w-1.5 h-1.5 bg-[#09C0F9] rounded-full mr-3"></div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-3xl sm:text-4xl font-bold text-[#09C0F9] mb-2">500+</div>
              <div className="text-gray-300 text-sm sm:text-base">Active Members</div>
            </div>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl font-bold text-[#09C0F9] mb-2">50+</div>
              <div className="text-gray-300 text-sm sm:text-base">Projects Completed</div>
            </div>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl font-bold text-[#09C0F9] mb-2">25+</div>
              <div className="text-gray-300 text-sm sm:text-base">Awards Won</div>
            </div>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl font-bold text-[#09C0F9] mb-2">100+</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl border border-gray-800/50 p-6">
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                "GAAC transformed my understanding of robotics. The hands-on projects and mentorship helped me land an internship at a top tech company."
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl border border-gray-800/50 p-6">
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                "The astronomy team opened my eyes to the wonders of space. Our telescope sessions and research projects are absolutely incredible!"
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl border border-gray-800/50 p-6">
              <div className="flex items-center mb-4">
                ...
                <div>
                  <div className="text-white font-semibold">Vikram Kumar</div>
                  <div className="text-gray-400 text-sm">4th Year, Mechanical</div>
                </div>
              </div>
              <p className="text-gray-300 text-sm leading-relaxed">
                "From coding competitions to building drones, GAAC provided the perfect platform to explore my passion for technology and innovation."
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="executive-body" className="relative z-10 py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <p className="text-[#898A8C] uppercase mb-4 font-dm-sans text-sm tracking-wider">
              Leadership Team
            ...
            <p className="text-gray-300 text-lg max-w-3xl mx-auto">
              Meet the dedicated leaders who drive innovation and excellence at GAAC
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl border border-gray-800/50 hover:border-[#09C0F9]/30 p-8 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-[#09C0F9]/10">
              <div className="text-center">
                <div className="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-[#09C0F9] to-[#0EA5E9] rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <span className="text-black font-bold text-2xl">AP</span>
                </div>
                ...
                <p className="text-gray-300 text-sm leading-relaxed mb-4">
                  Leading GAAC with vision and passion, driving innovation across all teams and fostering a culture of excellence.
                </p>
                <div className="flex justify-center space-x-3">
                  <a href="#" className="text-gray-400 hover:text-[#09C0F9] transition-colors">
            ...
            <div className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl border border-gray-800/50 hover:border-[#09C0F9]/30 p-8 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-[#09C0F9]/10">
              <div className="text-center">
                <div className="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-[#09C0F9] to-[#0EA5E9] rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <span className="text-black font-bold text-2xl">SM</span>
                </div>
                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-[#09C0F9] transition-colors">
                  Sneha Mehta
                </h3>
                <p className="text-[#09C0F9] font-semibold mb-3">Vice President</p>
                <p className="text-gray-300 text-sm leading-relaxed mb-4">
                  Supporting strategic initiatives and coordinating between teams to ensure seamless operations and growth.
                </p>
                <div className="flex justify-center space-x-3">
                  <a href="#" className="text-gray-400 hover:text-[#09C0F9] transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl border border-gray-800/50 hover:border-[#09C0F9]/30 p-8 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-[#09C0F9]/10">
              <div className="text-center">
                ...
                <p className="text-gray-300 text-sm leading-relaxed mb-4">
                  Managing communications, documentation, and ensuring smooth administrative operations across all club activities.
                </p>
                <div className="flex justify-center space-x-3">
                  <a href="#" className="text-gray-400 hover:text-[#09C0F9] transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl border border-gray-800/50 hover:border-[#09C0F9]/30 p-8 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-[#09C0F9]/10">
              <div className="text-center">
                <div className="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-[#09C0F9] to-[#0EA5E9] rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <span className="text-black font-bold text-2xl">AS</span>
                </div>
                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-[#09C0F9] transition-colors">
                  Ananya Singh
                </h3>
                <p className="text-[#09C0F9] font-semibold mb-3">Treasurer</p>
                <p className="text-gray-300 text-sm leading-relaxed mb-4">
                  Overseeing financial planning, budget management, and ensuring optimal resource allocation for all projects.
                </p>
                <div className="flex justify-center space-x-3">
                  <a href="#" className="text-gray-400 hover:text-[#09C0F9] transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl border border-gray-800/50 hover:border-[#09C0F9]/30 p-8 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-[#09C0F9]/10">
              <div className="text-center">
                <div className="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-[#09C0F9] to-[#0EA5E9] rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <span className="text-black font-bold text-2xl">VG</span>
                </div>
                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-[#09C0F9] transition-colors">
                  Vikash Gupta
                </h3>
                <p className="text-[#09C0F9] font-semibold mb-3">Technical Lead</p>
                <p className="text-gray-300 text-sm leading-relaxed mb-4">
                  Spearheading technical innovation, mentoring teams, and ensuring cutting-edge solutions across all domains.
                </p>
                <div className="flex justify-center space-x-3">
                  <a href="#" className="text-gray-400 hover:text-[#09C0F9] transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl border border-gray-800/50 hover:border-[#09C0F9]/30 p-8 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-[#09C0F9]/10">
              <div className="text-center">
                ...
                <p className="text-[#09C0F9] font-semibold mb-3">Events Coordinator</p>
                <p className="text-gray-300 text-sm leading-relaxed mb-4">
                  Organizing workshops, competitions, and community events that bring together passionate minds in technology.
                </p>
                <div className="flex justify-center space-x-3">
                  <a href="#" className="text-gray-400 hover:text-[#09C0F9] transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
