    ...
    <section className="text-white px-6 md:px-20 py-20">
      ...
      <div className="grid border-b border-gray-700 pb-12">
        <div className="text-center md:text-left">
          <h1
            className={`text-4xl md:text-5xl font-bold leading-tight mb-4 ${kumbhMedium.className}`}
          >
            Unlock a World of <br />
            <span className="text-white">Knowledge</span>
          </h1>
          <p className={`text-gray-400 ${interRegular.className}`}>
            Explore Our Projects, Collaborate, Share and Be a part of Our
            Amazing Journey!
          </p>
        </div>
      </div>
      ...
      <div className="grid border-b border-gray-700">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-0 text-center md:text-left">
          {[
            ...
            <div
              key={label}
              className={`py-12 px-12 border-gray-700 ${
                idx !== 3 ? "border-r" : ""
              }`}
              style={{
                display: "grid",
            ...
            >
              <h2
                className={`text-3xl font-semibold ${interSemiBold.className}`}
              >
                {number.includes("+") ? (
                  <>
                    {number.replace("+", "")}
      ...
      <div className="bg-[#1A1A1A] py-16 px-6 md:px-12 w-full">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <h2
            className={`text-3xl font-semibold text-white ${kumbhMedium.className}`}
          >
